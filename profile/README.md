...
See the [Fedora Atomic Desktops documentation](https://docs.fedoraproject.org/en-US/atomic-desktops/).
...
- [Source used to build Fedora Silverblue](https://pagure.io/workstation-ostree-config)
- [Source for the documentation](https://forge.fedoraproject.org/atomic-desktops/docs)
...
- [Other Fedora Atomic Desktops](https://fedoraproject.org/atomic-desktops/)
